---
title: 숲 (SOOP, 구 아프리카TV / 아프리카티비)
description: stream4j의 숲(SOOP, 구 아프리카TV) 개별 API 사용 가이드. 채팅, 별풍선 후원 이벤트, 방송 종료 감지, 로그인 인증 설정을 다룹니다.
---
...
숲(SOOP)은 로그인 없이도 사용할 수 있지만, 일부 기능은 로그인이 필요합니다.
