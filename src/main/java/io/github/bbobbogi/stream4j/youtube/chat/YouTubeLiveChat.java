...
import io.github.bbobbogi.stream4j.youtube.Util;
import io.github.bbobbogi.stream4j.youtube.types.LiveBroadcastDetails;
    ...
    private void getInitialData(String id, IdType type) throws IOException {
        this.isInitDataAvailable = true;
        {
            ...
            if (this.isReplay) {
                ...
                for (Object object : liveChatRenderer != null ? liveChatRenderer : new ArrayList<>()) {
